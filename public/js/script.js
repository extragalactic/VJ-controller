  ...
  function initControls () {
    ...
    */
    ...
    widget.on('*', function(data) {
      ...
      $window.nx.widgets.matrixLayer1.sequence(sequencerBPM);
      $window.nx.widgets.matrixLayer2.sequence(sequencerBPM);
      $window.nx.widgets.matrixLayer3.sequence(sequencerBPM);
    });
